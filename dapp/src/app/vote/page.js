        ...
        <div className="row align-items-center">
          ...
          <p className="lead">BBB on-chain voting.</p>
          {
            voting.maxDate > (Date.now() / 1000)
              ? <p className="lead mb-3">You have until {new Date(Number(voting.maxDate) * 1000).toString()} to cast your vote for one of the participants below so that they can leave the program.</p>
              : <p className="lead mb-3">Voting closed. Check out the results below.</p>
          }
        </div>
        <div className="row flex-lg-row-reverse align-items-center g-1 py-1">
          ...
          <div className="col-5">
            ...
            <img src={option2.image} className="d-block mx-auto img-fluid rounded" width={250} height={250} />
            {
              showVotes > 0 || voting.maxDate < (Date.now() / 1000)
                ...
                : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={btnVote2Click}>I want this one to come out</button>
            }
          </div>
          <div className="col-5">
            <h3 className="my-2 d-block mx-auto" style={{ width: 250 }}>
            ...
            <img src={option1.image} className="d-block mx-auto img-fluid rounded" width={250} height={250} />
            {
              showVotes > 0 || voting.maxDate < (Date.now() / 1000)
                ...
                : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={btnVote1Click}>I want this one to come out</button>
            }
          </div>
        </div>
        <div className="row align-items-center">
